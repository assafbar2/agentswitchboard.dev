...
const _AGENTS_ADDED_2026_08_24_SWEEP: AgentInput[] = [
  // ── Mode A — launched inside the 9-day window ────────────────────────────
  {
    name: 'Cursor Origin',
    slug: 'cursor-origin',
    description: 'Git code hosting from Cursor built for agent-driven development, with repository storage, review surfaces, and native integration into the Cursor editor.',
    providerName: 'Cursor',
    providerUrl: 'https://cursor.com',
    agentUrl: 'https://cursor.com/docs/origin',
    categories: ['code-devtools', 'infrastructure'],
    tags: ['code-hosting', 'git', 'version-control', 'cursor', 'code-review'],
    authType: 'oauth2',
    accessMethods: ['api', 'cli'],
    supportsStreaming: false,
    supportsPushNotifications: true,
  },
  {
    name: 'Huzzah',
    slug: 'huzzah',
    description: 'Coding agent built around a structured edit protocol rather than freeform file rewriting, aiming for smaller and more reviewable diffs.',
    providerName: 'Daniel Vaughn',
    providerUrl: 'https://www.danielvaughn.dev',
    agentUrl: 'https://github.com/danielvaughn/hz',
    categories: ['code-devtools'],
    tags: ['coding-assistant', 'structured-edits', 'diff-review', 'open-source'],
    authType: 'none',
    accessMethods: ['cli'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'fx',
    slug: 'fx-agent',
    description: 'Tiny native coding agent with no runtime dependency, designed to stay small and fast while driving edits and shell commands locally.',
    providerName: 'fx',
    providerUrl: 'https://fx.sh',
    agentUrl: 'https://fx.sh',
    categories: ['code-devtools'],
    tags: ['coding-assistant', 'native-binary', 'lightweight', 'local-first'],
    authType: 'apiKey',
    accessMethods: ['cli'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'Munder Difflin',
    slug: 'munder-difflin',
    description: 'Agent harness that runs a simulated office of collaborating agents, assigning roles and routing work between them on shared tasks.',
    providerName: 'Munder Difflin',
    providerUrl: 'https://munderdiffl.in',
    agentUrl: 'https://munderdiffl.in',
    categories: ['orchestration'],
    tags: ['multi-agent', 'role-assignment', 'task-routing', 'harness'],
    authType: 'apiKey',
    accessMethods: ['api'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'Autolith',
    slug: 'autolith',
    description: 'Programming agent that keeps a live runtime alongside the code, letting it evaluate and inspect program state while editing rather than only reading text.',
    providerName: 'Lambda Symbolics',
    providerUrl: 'https://www.lambda-symbolics.com',
    agentUrl: 'https://www.lambda-symbolics.com/autolith',
    categories: ['code-devtools', 'orchestration'],
    tags: ['live-runtime', 'coding-assistant', 'repl', 'state-inspection'],
    authType: 'apiKey',
    accessMethods: ['api', 'cli'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'Speko',
    slug: 'speko',
    description: 'Unified routing API for voice models across providers, giving voice agents one interface for speech-to-text, text-to-speech, and fallback. Y Combinator S26.',
    providerName: 'Speko',
    providerUrl: 'https://speko.ai',
    agentUrl: 'https://speko.ai',
    categories: ['voice-messaging', 'infrastructure'],
    tags: ['voice-routing', 'speech-models', 'unified-api', 'fallback-routing'],
    authType: 'apiKey',
    accessMethods: ['api'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'MathCode',
    slug: 'mathcode',
    description: 'Mathematical coding agent that formalizes and verifies mathematical reasoning by generating and checking executable code alongside proofs.',
    providerName: 'Math-AI',
    providerUrl: 'https://math-ai-org.github.io',
    agentUrl: 'https://math-ai-org.github.io/mathcode/',
    categories: ['research', 'code-devtools'],
    tags: ['mathematical-reasoning', 'formal-verification', 'proof-checking', 'research'],
    authType: 'none',
    accessMethods: ['cli'],
    supportsStreaming: false,
    supportsPushNotifications: false,
  },
  {
    name: 'OzBrain',
    slug: 'ozbrain',
    description: 'Shared knowledge layer that lets multiple agents read and write to a common memory, so context learned by one agent is available to the others.',
    providerName: 'OzBrain',
    providerUrl: 'https://ozbrain.com',
    agentUrl: 'https://ozbrain.com',
    categories: ['memory-state', 'orchestration'],
    tags: ['shared-memory', 'knowledge-base', 'cross-agent-context', 'persistence'],
    authType: 'apiKey',
    accessMethods: ['api', 'mcp'],
    supportsStreaming: false,
    supportsPushNotifications: false,
  },
  {
    name: 'machine0',
    slug: 'machine0',
    description: 'Persistent CPU and GPU virtual machines for agents that need long-running state, letting a session keep its filesystem and processes between runs. Y Combinator S26.',
    providerName: 'machine0',
    providerUrl: 'https://machine0.io',
    agentUrl: 'https://machine0.io',
    categories: ['infrastructure'],
    tags: ['persistent-vm', 'gpu-compute', 'sandboxed-execution', 'long-running'],
    authType: 'apiKey',
    accessMethods: ['api', 'cli'],
    supportsStreaming: false,
    supportsPushNotifications: false,
  },
  {
    name: 'Vendo',
    slug: 'vendo',
    description: 'Open-source layer that lets end users build features on top of your product using agents, with scoped execution and review. Y Combinator S26.',
    providerName: 'Vendo',
    providerUrl: 'https://github.com/runvendo',
    agentUrl: 'https://github.com/runvendo/vendo',
    categories: ['code-devtools', 'orchestration'],
    tags: ['user-extensibility', 'scoped-execution', 'open-source', 'embedded-agents'],
    authType: 'apiKey',
    accessMethods: ['cli', 'api'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'Proliferate',
    slug: 'proliferate',
    description: 'Open-source, self-hostable coding agent platform for running cloud coding sessions on your own infrastructure.',
    providerName: 'Proliferate AI',
    providerUrl: 'https://github.com/proliferate-ai',
    agentUrl: 'https://github.com/proliferate-ai/proliferate',
    categories: ['code-devtools', 'infrastructure'],
    tags: ['self-hosted', 'cloud-coding', 'open-source', 'session-management'],
    authType: 'apiKey',
    accessMethods: ['cli', 'api'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  ...
  // ── Mode B — major AI coding products missing from the catalog ───────────
  {
    name: 'v0',
    slug: 'v0',
    description: "Vercel's generative UI agent that turns prompts into working React and Next.js interfaces, with iterative refinement and direct deploy.",
    providerName: 'Vercel',
    providerUrl: 'https://vercel.com',
    agentUrl: 'https://v0.app',
    categories: ['code-devtools', 'content-media'],
    tags: ['generative-ui', 'react', 'nextjs', 'vercel', 'prototyping'],
    authType: 'apiKey',
    accessMethods: ['api'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'Jules',
    slug: 'jules',
    description: "Google's asynchronous coding agent that clones a repository, plans a change, and opens a pull request without holding an interactive session.",
    providerName: 'Google',
    providerUrl: 'https://google.com',
    agentUrl: 'https://jules.google',
    categories: ['code-devtools'],
    tags: ['asynchronous-coding', 'pull-requests', 'google', 'repository-tasks'],
    authType: 'oauth2',
    accessMethods: ['api'],
    supportsStreaming: false,
    supportsPushNotifications: true,
  },
  {
    name: 'Zed',
    slug: 'zed',
    description: 'High-performance collaborative code editor written in Rust with a built-in agent panel, edit prediction, and MCP client support.',
    providerName: 'Zed Industries',
    providerUrl: 'https://zed.dev',
    agentUrl: 'https://zed.dev/docs',
    categories: ['code-devtools'],
    tags: ['code-editor', 'rust', 'collaborative-editing', 'mcp-client'],
    authType: 'oauth2',
    accessMethods: ['cli'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'Amp',
    slug: 'amp',
    description: "Sourcegraph's autonomous coding agent that works across large codebases using code search and indexing to ground its edits.",
    providerName: 'Sourcegraph',
    providerUrl: 'https://sourcegraph.com',
    agentUrl: 'https://ampcode.com',
    categories: ['code-devtools', 'orchestration'],
    tags: ['code-search', 'large-codebase', 'sourcegraph', 'autonomous-editing'],
    authType: 'apiKey',
    accessMethods: ['cli', 'api'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'Lovable',
    slug: 'lovable',
    description: 'Prompt-to-app builder that generates full-stack web applications with database, auth, and deploy wired up from a natural-language brief.',
    providerName: 'Lovable',
    providerUrl: 'https://lovable.dev',
    agentUrl: 'https://docs.lovable.dev',
    categories: ['code-devtools'],
    tags: ['app-builder', 'full-stack', 'prompt-to-app', 'prototyping'],
    authType: 'apiKey',
    accessMethods: ['api'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'Augment Code',
    slug: 'augment-code',
    description: 'Coding assistant that indexes large proprietary codebases to provide context-aware completions, chat, and multi-file agent edits.',
    providerName: 'Augment',
    providerUrl: 'https://www.augmentcode.com',
    agentUrl: 'https://docs.augmentcode.com',
    categories: ['code-devtools'],
    tags: ['codebase-indexing', 'context-retrieval', 'multi-file-edits', 'enterprise'],
    authType: 'oauth2',
    accessMethods: ['api'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'Tabnine',
    slug: 'tabnine',
    description: 'Code completion and chat assistant with self-hosted and air-gapped deployment options for teams with strict code-privacy requirements.',
    providerName: 'Tabnine',
    providerUrl: 'https://www.tabnine.com',
    agentUrl: 'https://docs.tabnine.com',
    categories: ['code-devtools', 'security'],
    tags: ['code-completion', 'self-hosted', 'air-gapped', 'code-privacy'],
    authType: 'apiKey',
    accessMethods: ['api'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    ...
    description: 'Google cloud workspace for building and deploying full-stack AI applications, combining an agentic editor with Firebase backend services.',
    providerName: 'Google',
    providerUrl: 'https://firebase.google.com',
    agentUrl: 'https://firebase.studio',
    categories: ['code-devtools', 'infrastructure'],
    tags: ['cloud-workspace', 'firebase', 'full-stack', 'google'],
    authType: 'oauth2',
    accessMethods: ['api'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  ...
  // ── Mode B — platform API gaps ───────────────────────────────────────────
  {
    name: 'Atlassian MCP Server',
    slug: 'atlassian-mcp',
    description: 'Official Atlassian MCP server giving agents access to Jira issues and Confluence pages for search, creation, and updates.',
    providerName: 'Atlassian',
    providerUrl: 'https://www.atlassian.com',
    agentUrl: 'https://github.com/atlassian/atlassian-mcp-server',
    categories: ['orchestration', 'communication'],
    tags: ['jira', 'confluence', 'issue-tracking', 'official-mcp', 'atlassian'],
    authType: 'oauth2',
    accessMethods: ['mcp'],
    supportsStreaming: false,
    supportsPushNotifications: false,
  },
  {
    name: 'GitLab',
    slug: 'gitlab',
    description: 'DevOps platform with a documented REST and GraphQL API for repositories, merge requests, CI pipelines, and issues.',
    providerName: 'GitLab',
    providerUrl: 'https://gitlab.com',
    agentUrl: 'https://docs.gitlab.com/api/rest/',
    categories: ['code-devtools', 'infrastructure'],
    tags: ['version-control', 'merge-requests', 'ci-pipelines', 'devops'],
    authType: 'oauth2',
    accessMethods: ['api', 'cli'],
    supportsStreaming: false,
    supportsPushNotifications: true,
  },
  {
    name: 'Zoom',
    slug: 'zoom',
    description: 'Meetings platform with APIs for scheduling, recordings, transcripts, and webhooks that agents can use to run and summarize calls.',
    providerName: 'Zoom',
    providerUrl: 'https://zoom.us',
    agentUrl: 'https://developers.zoom.us/docs',
    categories: ['communication', 'scheduling'],
    tags: ['video-meetings', 'transcripts', 'recordings', 'webhooks'],
    authType: 'oauth2',
    accessMethods: ['api'],
    supportsStreaming: false,
    supportsPushNotifications: true,
  },
  {
    name: 'Algolia',
    slug: 'algolia',
    description: 'Hosted search and discovery API with typo tolerance, faceting, and vector search, callable directly for agent retrieval workloads.',
    providerName: 'Algolia',
    providerUrl: 'https://www.algolia.com',
    agentUrl: 'https://www.algolia.com/doc',
    categories: ['research', 'vector-databases'],
    tags: ['hosted-search', 'faceted-search', 'vector-search', 'retrieval'],
    authType: 'apiKey',
    accessMethods: ['api'],
    supportsStreaming: false,
    supportsPushNotifications: false,
  },
  {
    name: 'Contentful',
    slug: 'contentful',
    description: 'Headless CMS with content delivery and management APIs, letting agents read and publish structured content programmatically.',
    providerName: 'Contentful',
    providerUrl: 'https://www.contentful.com',
    agentUrl: 'https://www.contentful.com/developers/docs/',
    categories: ['content-media'],
    tags: ['headless-cms', 'content-delivery', 'structured-content', 'publishing'],
    authType: 'bearer',
    accessMethods: ['api', 'cli'],
    supportsStreaming: false,
    supportsPushNotifications: true,
  },
  {
    name: 'Railway',
    slug: 'railway',
    description: 'Deployment platform with a GraphQL API and CLI for provisioning services, databases, and environments from code.',
    providerName: 'Railway',
    providerUrl: 'https://railway.com',
    agentUrl: 'https://docs.railway.com',
    categories: ['infrastructure'],
    tags: ['deployment', 'hosting', 'graphql-api', 'environments'],
    authType: 'apiKey',
    accessMethods: ['api', 'cli'],
    supportsStreaming: false,
    supportsPushNotifications: true,
  },
  {
    name: 'Render',
    slug: 'render',
    description: 'Cloud platform with a REST API and CLI for deploying web services, cron jobs, and managed databases without server management.',
    providerName: 'Render',
    providerUrl: 'https://render.com',
    agentUrl: 'https://render.com/docs',
    categories: ['infrastructure'],
    tags: ['deployment', 'managed-hosting', 'cron-jobs', 'managed-databases'],
    authType: 'bearer',
    accessMethods: ['api', 'cli'],
    supportsStreaming: false,
    supportsPushNotifications: true,
  },
  {
    name: 'BigQuery',
    slug: 'bigquery',
    description: 'Google Cloud serverless data warehouse queryable over SQL through a REST API, commonly used as an analytics backend for agents.',
    providerName: 'Google',
    providerUrl: 'https://cloud.google.com',
    agentUrl: 'https://cloud.google.com/bigquery/docs',
    categories: ['data-analytics'],
    tags: ['data-warehouse', 'sql', 'analytics', 'google-cloud'],
    authType: 'oauth2',
    accessMethods: ['api', 'cli'],
    supportsStreaming: true,
    supportsPushNotifications: false,
  },
  {
    name: 'Discord',
    slug: 'discord',
    description: 'Chat platform with a documented REST API, gateway, and bot framework for agents that read channels, post messages, and respond to events.',
    providerName: 'Discord',
    providerUrl: 'https://discord.com',
    agentUrl: 'https://discord.com/developers/docs',
    categories: ['communication'],
    tags: ['chat-platform', 'bot-api', 'gateway-events', 'community'],
    authType: 'bearer',
    accessMethods: ['api'],
    supportsStreaming: true,
    supportsPushNotifications: true,
