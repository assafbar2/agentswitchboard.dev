...
const AGENTS_TO_ADD: AgentInput[] = [
  ...
  //   name: 'My Agent',
  //   slug: 'my-agent',
  //   description: 'What it does and who it is for. Hard limit 200 chars.',
  //   providerName: 'Provider Name',
  //   providerUrl: 'https://provider.com',
  //   agentUrl: 'https://provider.com/docs',
  //   categories: ['research'],
  ...
  //   verified: true,
  //   skills: [
  //     { id: 'skill-one', name: 'Skill One', description: 'Does X for Y in Z way with clear outcome' },
  //     { id: 'skill-two', name: 'Skill Two', description: 'Does A for B in C way with clear outcome' },
  //     { id: 'skill-three', name: 'Skill Three', description: 'Does D for E in F way with clear outcome' },
  //     { id: 'skill-four', name: 'Skill Four', description: 'Does G for H in I way with clear outcome' },
  //     { id: 'skill-five', name: 'Skill Five', description: 'Does J for K in L way with clear outcome' },
  //   ],
  // },
];
// ─────────────────────────────────────────────────────────────────────────────
