...
const AGENTS_TO_ADD: AgentInput[] = [
  {
    name: 'Airbyte Agents',
    slug: 'airbyte-agents',
    description: 'Context layer for AI agents: MCP server and Python SDK giving agents unified access to 50+ business data connectors with pre-assembled context, reducing tool calls by 40–80%.',
    providerName: 'Airbyte',
    providerUrl: 'https://airbyte.com',
    agentUrl: 'https://airbyte.com/airbyte-agents',
    categories: ['data-analytics', 'infrastructure'],
    tags: ['data-connectors', 'context-layer', 'mcp-server', 'business-data', 'salesforce', 'hubspot', 'rag'],
    authType: 'apiKey',
    ...
    skills: [
      {
        id: 'context-store-search',
        name: 'Context Store Search',
        description: 'Search pre-assembled business context across Salesforce, HubSpot, Zendesk, Linear, Slack, and 45+ connectors before making live API calls.',
      },
      {
        id: 'live-connector-reads',
        name: 'Live Connector Reads',
        description: 'Fetch fresh data from source systems with write-back support to update records, tickets, and messages in the systems of record.',
      },
      {
        id: 'agent-sdk-integration',
        name: 'Agent SDK Integration',
        description: 'Integrate connectors into pydantic-ai, LangChain, OpenAI Agents, and FastMCP via typed Python decorators with built-in retry and error handling.',
      },
    ],
  },
  {
    name: 'Vennio',
    slug: 'vennio',
    description: 'Scheduling infrastructure for developers and AI agents. Query real availability across multiple calendars, create bookings, and negotiate meeting times via REST API and MCP.',
    providerName: 'Vennio',
    providerUrl: 'https://vennio.app',
    agentUrl: 'https://docs.vennio.app',
    categories: ['scheduling'],
    tags: ['scheduling-api', 'calendar-availability', 'booking-api', 'mcp-server', 'multi-calendar', 'stripe-payments'],
    authType: 'apiKey',
    ...
    skills: [
      {
        id: 'find-mutual-availability',
        name: 'Find Mutual Availability',
        description: 'Query open slots across multiple calendars simultaneously with consent-scoped access for multi-party scheduling.',
      },
      {
        id: 'create-booking',
        name: 'Create Booking',
        description: 'Create confirmed calendar bookings with event creation and confirmation emails in a single API call, including Stripe payment support.',
      },
      {
        id: 'manage-venn-links',
        name: 'Manage Venn Links',
        description: 'Create and manage shareable booking pages programmatically, enabling AI agents to generate scheduling links on behalf of users.',
      },
    ],
  },
  {
    ...
    description: 'Security scanner for MCP servers and agent skills. Detects prompt injections, tool poisoning, and sensitive data risks across Claude, Cursor, Windsurf, and 10+ other agents.',
    providerName: 'Snyk',
    providerUrl: 'https://snyk.io',
    agentUrl: 'https://github.com/snyk/agent-scan',
    categories: ['security'],
    tags: ['security-scanner', 'mcp-security', 'prompt-injection', 'agent-security', 'supply-chain', 'vulnerability-detection'],
    authType: 'apiKey',
    accessMethods: ['cli'],
    supportsStreaming: false,
    supportsPushNotifications: false,
    ...
    skills: [
      {
        ...
        description: 'Auto-discover and scan installed MCP server configurations for prompt injections, tool poisoning, and tool shadowing attacks.',
      },
      {
        id: 'scan-agent-skills',
        name: 'Scan Agent Skills',
        description: 'Inventory and analyze agent skills across Claude Code, Codex, and Cursor for malware payloads hidden in natural language.',
      },
      {
        id: 'security-report',
        name: 'Security Report',
        description: 'Generate detailed security reports with severity ratings across 15+ distinct risk categories for all installed agent components.',
      },
    ],
  },
  {
